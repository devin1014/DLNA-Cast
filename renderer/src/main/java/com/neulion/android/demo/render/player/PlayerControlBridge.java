 ...
 * Time: 18:30
 */
public class PlayerControlBridge implements IControlBridge
{
    ...
    public PlayerControlBridge(Activity activity, NLUpnpRendererService service, CommonVideoController controller)
    {
        mActivity = activity;
    ...
    {
        //final int lastVolume = mAudioManager.getStreamVolume(AudioManager.STREAM_MUSIC);

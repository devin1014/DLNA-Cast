...
import com.neulion.android.demo.render.upnp.AVTransportControlImp;
import com.neulion.android.demo.render.upnp.AudioControlImp;
import com.neulion.android.demo.render.upnp.ControlBridgeListener;
import com.neulion.android.demo.render.upnp.IAudioControl;
import com.neulion.android.demo.render.upnp.IControlBridge;
...
import com.neulion.android.demo.render.upnp.RendererConnectionManagerService;
...
public class NLUpnpRendererService extends AndroidUpnpServiceImpl
{
    ...
    private ControlBridgeListener mControlBridgeListener = new ControlBridgeListener();
    ...
    public void onCreate()
    {
        ...
        for (int i = 0; i < 1; i++)
        {
            AVTransportControlImp controlImp = new AVTransportControlImp(getApplicationContext(), new UnsignedIntegerFourBytes(i), mControlBridgeListener);
        ...
        for (int i = 0; i < 1; i++)
        {
            AudioControlImp controlImp = new AudioControlImp(getApplicationContext(), new UnsignedIntegerFourBytes(i), mControlBridgeListener);
    ...
    public void registerControlBridge(IControlBridge bridge)
    {
        mControlBridgeListener.register(bridge);
    }

    public void unregisterControlBridge(IControlBridge bridge)
    {
        mControlBridgeListener.unregister(bridge);
    }
}

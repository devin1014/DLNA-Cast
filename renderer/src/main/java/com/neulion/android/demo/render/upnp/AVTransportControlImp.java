...
import com.neulion.android.demo.render.player.NLCastVideoPlayerActivity;
...
public class AVTransportControlImp implements IAVTransport
{
    ...
    private IControlBridge mControlListener;

    public AVTransportControlImp(Context context, UnsignedIntegerFourBytes instanceId, IControlBridge listener)
    {

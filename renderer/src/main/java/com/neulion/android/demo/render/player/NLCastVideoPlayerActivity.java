...
import com.neulion.android.demo.render.NLUpnpRendererService.RendererServiceBinder;
import com.neulion.android.demo.render.R;
import com.neulion.android.demo.render.player.RendererThread.AudioControlThread;
import com.neulion.android.demo.render.player.RendererThread.AvControlThread;
import com.neulion.android.demo.render.utils.CastUtils;
...
{
    private static final String KEY_EXTRA_URL = "com.neulion.android.demo.render.player.key.extra_url";
    private static final String KEY_EXTRA_METADATA = "com.neulion.android.demo.render.player.key.extra_metadata";
    ...
    public static void startActivity(Context context, String url, String metaData)
    {
        ...
        intent.putExtra(KEY_EXTRA_METADATA, metaData);
    ...
    private PlayerControlBridge mPlayerControlBridge;
    ...
    protected void onDestroy()
    {
        ...
        if (mRendererService != null)
        {
            mRendererService.unregisterControlBridge(mPlayerControlBridge);
        }
    ...
    private ServiceConnection mRendererServiceConnection = new ServiceConnection()
    {
        ...
        public void onServiceConnected(ComponentName name, IBinder service)
        {
            ...
            mRendererService.registerControlBridge(mPlayerControlBridge = new PlayerControlBridge(NLCastVideoPlayerActivity.this, mRendererService, mVideoController));

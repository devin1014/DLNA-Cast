...
public class Constants
{
    ...
    private static final String CAST_URL_CNTV_SAMPLE = "http://stitchcast.nlv2.com/live/cntv/2019/game22810_sd_cast.m3u8?auth_key=45e7b90b7765035ce1c2cc388a7716fc-1551352740-32-*";
    private static final int _30_MIN = 30 * 60 * 1000;

    public static final String CAST_URL = CAST_URL_CNTV_SAMPLE;
